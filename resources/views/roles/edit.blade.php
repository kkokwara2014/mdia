...
<div class="page-header d-print-none mb-3">
    <div class="row g-2 align-items-center">
        <div class="col">
            <h2 class="page-title">Edit {{ $role->name }}</h2>
        </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                    ...
                    <label class="form-selectgroup-item flex-fill">
                        <input type="checkbox" name="permissions[]" value="{{ $permission->uuid }}" class="form-selectgroup-input" {{ in_array($permission->uuid, old('permissions', $role->permissions->pluck('uuid')->toArray())) ? 'checked' : '' }}>
